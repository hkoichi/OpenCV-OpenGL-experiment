...
void glut_display(){
    ...
    GLfloat lightpos1[] = {5 * cos(g_angle4) * sin(g_angle3),
                          5 * sin(g_angle4),
                          5 * cos(g_angle4) * cos(g_angle3),
                          1.0};
    GLfloat lightpos2[] = {5 * cos(g_angle4) * sin(g_angle3 + 3.14),
                           5 * sin(g_angle4),
                           5 * cos(g_angle4) * cos(g_angle3 + 3.14),
                           1.0};
    GLfloat diffuse1[] = {1.0, 1.0, 1.0, 1.0};
    GLfloat diffuse2[] = {1.0, 140/255, 0.0, 1.0};
    ...
    glPushMatrix();
    glTranslatef(5 * cos(g_angle4) * sin(g_angle3 + 3.14), 5 * sin(g_angle4),
                 5 * cos(g_angle4) * cos(g_angle3 + 3.14));
    glutSolidSphere(0.2, 50, 50);
    glPopMatrix();
