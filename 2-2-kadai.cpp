...
void glut_display(){
    ...
    glRotatef(g_angle1 * g_distance,
                  0,
                  1,
                  0);
    glRotatef(g_angle2 * g_distance,
              1,
              0,
              0);
...
void draw_cube(){
    ...
    GLdouble pointB[] = {1.0, 0.0, 0.0};
    GLdouble pointC[] = {0.0, 1.0, 0.0};
    GLdouble pointD[] = {0.0, 0.0, 1.0};
    GLdouble pointE[] = {1.0, 1.0, 0.0};
    GLdouble pointF[] = {0.0, 1.0, 1.0};
